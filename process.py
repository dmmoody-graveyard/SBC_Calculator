class Adjudicate:
	...
	def full_copay(self, copay_amount):
		self.copay_amount = copay_amount
		self.amount -= self.copay_amount

	# Assess copay when amount is less than copay amount
	def partial_copay(self, copay_amount):
		self.copay_amount = self.amount
		self.amount -= self.copay_amount
